        ...
        <>
            <header className={styles['header']}>
                ...
                <div className={styles['header__navbar']}>
                    {props.showSocial && !props.navState && (
                    ...
                    {props.navState && !settingsState && (
                        <a aria-label="Přejít na stránku Nastavení" onClick={() => setSettingsState(true)}>
                    ...
                    {settingsState && (
                        <a aria-label="Otevřít hlavní menu" onClick={() => setSettingsState(false)}>
